                                ...
                                <div class="container">
                                  <div class="row">
                                    <div class="col-xl-6 offset-xl-3">
                                        ...
                                        <!-- Sign Up Form -->
                                        <form action = "http:\\localhost\RPL\crud\register.php" method = "POST">
                                          <div class="mb-4 form-floating">
                                            <input type="text" class="form-control" name="username" placeholder="Your name" minlength = "4" maxlength = "30" required/>
                                        </div>
                                        <div class="mb-4 form-floating">
                                          ...
                                          <button type = "submit" name = "submit" class="btn_3">Sign Up</button>
                                        </form>
                                        <div class="text-box mt-2 mb-2">
                                            <p class="mb-2">Already have an account?<a class="blue" href="http://localhost/RPL/RPLori/login.php"> Log in</a></p>
